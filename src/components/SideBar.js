...
import { BiBell, BiHeart, BiMessageDetail } from 'react-icons/bi'
    ...
    <Wrapper>
      <section className={` ${sideBarOpen ? 'show-sidebar' : ''}`}>
        <header>
          ...
          <button className='btn' onClick={toggleSide}>
        ...
        <div className='bottom section'>
          <div className='s-b-left'>
            <Link to='/user/sign_in' style={{ color: '#FF6E13' }}>
              <span style={{ color: '#FF6E13' }}>Se connecter</span>
            </Link>
          </div>
          <div className='b-bottom'></div>
          <div className='s-b'>
